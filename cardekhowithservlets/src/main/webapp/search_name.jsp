...
<main>
        ...
        <br>
        <br>
    <h1 style="color: white" align="center">Search Car By Name</h1>
    <form action="Search_by_Name" method="get" id="form">
       
        
        <input type="text" id="id" name="name" style="color: white;" placeholder="Enter the car Name here" required="required">
        <br>
